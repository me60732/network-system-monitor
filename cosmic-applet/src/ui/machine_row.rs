//! # MachineRow — Single row in GridWindow representing one remote machine
//!
...
impl MachineRow {
    /// Create a new MachineRow with the given name and initial status.
    ...
    pub fn update_from_packet(&mut self, packet: &nmd_service::packet::MetricPacket) {
        ...
        // TX not available in current packet, keep at 0
...
impl Default for MachineRow {
    fn default() -> Self {
        MachineRow::new("unknown".to_string(), MachineStatus::Pending)
    }
}
